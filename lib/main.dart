...
var kcolorSchemebutton = ColorScheme.fromSeed(
    seedColor: const Color.fromARGB(255, 3, 133, 220));
...
Future main() async {
  ...
  try {
    await Firebase.initializeApp(
      options: const FirebaseOptions(apiKey: "AIzaSyAzKPOIskP5oNdZdMQTvNS6FCtuFEm-rvM", appId: "1:759636103560:android:8c86b6737971c34421ea3d", messagingSenderId: "759636103560", projectId: "circleofmusic")
    );
  } catch (e) {
   return;
  }
