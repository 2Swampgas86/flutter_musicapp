...
//             final audioplayer = AudioPlayer(); // Handle audio player locally
...
//                     controller:_controller ,
//                     onPageChanged: (page) {
//                       // Dispatch event to the Bloc when the page changes
//                       context.read<InfoBloc>().add(PageChanged(
//                             page: page,
//                             moduleinfo: pageList,
//                           ));
//                     },
...
//                                 style: TextButton.styleFrom(
//                                   padding: const EdgeInsets.all(10),
//                                   backgroundColor: const Color.fromARGB(255, 49,
//                                       189, 236), // Blue background color
//                                   shape: const StadiumBorder(
//                                     side: BorderSide(
//                                       color: Colors.black,
//                                       width: 2,
...
//   Future<void> openDialog(BuildContext context, String userhint) async {
//     showDialog(
//         context: context,
//         builder: (context) => AlertDialog(
//               title: const Text("Hint!"),
